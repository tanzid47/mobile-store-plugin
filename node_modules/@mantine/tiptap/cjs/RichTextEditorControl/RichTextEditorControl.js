...
const RichTextEditorControl = core.factory((_props, ref) => {
  ...
  const _a = props, { classNames, className, style, styles, vars, interactive, active } = _a, others = __objRest(_a, ["classNames", "className", "style", "styles", "vars", "interactive", "active"]);
