...
function createDropzoneStatus(status) {
  const Component = (props) => {
    const _a = core.useProps(`Dropzone${hooks.upperFirst(status)}`, {}, props), { children } = _a, others = __objRest(_a, ["children"]);
    const ctx = Dropzone_context.useDropzoneContext();
    const _children = core.isElement(children) ? children : /* @__PURE__ */ React__default.createElement("span", null, children);
    if (ctx[status]) {
